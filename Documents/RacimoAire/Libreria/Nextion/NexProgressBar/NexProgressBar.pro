#-------------------------------------------------
#
# Project created by QtCreator 2018-09-20T06:05:48
#
#-------------------------------------------------

QT       -= gui

TARGET = NexProgressBar
TEMPLATE = lib

DEFINES += NEXPROGRESSBAR_LIBRARY
...
SOURCES += nexprogressbar.cpp

HEADERS += nexprogressbar.h\
        nexprogressbar_global.h
