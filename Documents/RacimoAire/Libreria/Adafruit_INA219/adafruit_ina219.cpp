...
*/
/**************************************************************************/
Adafruit_INA219::Adafruit_INA219(Crpigpio *GPIO, uint8_t addr) {
  RA_cGPIO = GPIO;
  ina219_i2caddr = addr;
  RA_cGPIO->OpenI2C(1,ina219_i2caddr,0);
...
{
   m_InitOK = RA_cGPIO->WriteDeviceI2C(reg,value);
...
void Adafruit_INA219::setCalibration_32V_1A(void)
{
  ...
  ina219_powerMultiplier_mW = 0.8f;         // Power LSB = 800mW per bit
...
int Adafruit_INA219::getInitOK() const
{
    return m_InitOK;
}
