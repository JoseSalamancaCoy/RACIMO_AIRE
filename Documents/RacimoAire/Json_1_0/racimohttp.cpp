...
{
    system("GetHttpCurl >/home/josesalamanca/RACIMOAIRE/DataIntercambio/FechaHora.json");
    QFile ArchivoFechaHora("/home/josesalamanca/RACIMOAIRE/DataIntercambio/FechaHora.json");
